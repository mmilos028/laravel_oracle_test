...
class VoucherExcelController extends Controller
{
    ...
    public function voucherCreateExcel(Request $request)
    {
        ...
        $exportExcel = new VoucherExportExcel($backoffice_session_id, $backoffice_username, $from_serial, $to_serial);
        
        return Excel::download($exportExcel, "vouchers_list_{$from_serial}_{$to_serial}.xlsx");
    }    
}